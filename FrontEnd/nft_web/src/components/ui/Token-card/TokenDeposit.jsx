...
import { deposit } from "../../../depositNFT";
const { ethers } = require("ethers");

const TokenDeposit = ({ setShowModal, token }) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      deposit(tokens.id, ethers.utils.parseUnits(values.amount, token.decimal)).then((res) => {
        if (res) {
          setShowModal(false);
        }
      });
